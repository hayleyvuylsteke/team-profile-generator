...
buildPageShell = () => {
    ...
    <body>
        ...
        fs.writeFile("../dist/team-profile.html", htmlTop, function(err) {
            if (err) {
                console.log(err)
            }
        })
...
finishPageShell = () => {
    ...
    `
    fs.appendFile("../dist/team-profile.html", htmlBottom, function(err) {
        if (err) {
            console.log(err)
        } else {
...
buildTeamProfile = () => {
    ...
    for (var i = 0; i < employees.length; i++) {
        ...
        fs.appendFile("../dist/team-profile.html", employeeCard, function(err) {
            if (err) {
                console.log(err)
            }
        })
